...
static const float3 p0 = float3(0.0f, 0.0f, -0.094f);
static const float3 p1 = float3(1.0f, 0.0f, -0.7f);
static const float3 p2 = float3(1.0f, 0.0f, 0.943f);
static const float3 p3 = float3(0.f, 0.0f, 1.0f);
