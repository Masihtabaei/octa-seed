...
static const float3 TEXTURE_COLOR = float3(0.545f, 0.008f, 0.008f);

static const float3 P0 = float3(0.000, 0.000, -0.059);
static const float3 P1 = float3(1.000, 0.000, -0.529);
static const float3 P2 = float3(0.833, 0.000, 1.118);
