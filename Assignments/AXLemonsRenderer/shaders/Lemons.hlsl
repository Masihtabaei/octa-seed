...
static const float3 TEXTURE_COLOR = float3(1.0f, 0.957f, 0.31f);

static const float3 P0 = float3(0.000, 0.000, -0.765);
static const float3 P1 = float3(0.230, 0.000, -0.765);
static const float3 P2 = float3(1.071, 0.000, 0.176);
static const float3 P3 = float3(0.000, 0.000, 0.882);
