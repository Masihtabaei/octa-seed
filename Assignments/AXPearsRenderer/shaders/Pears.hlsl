...
static const float3 TEXTURE_COLOR = float3(0.788f, 0.8f, 0.247f);

static const float3 P0 = float3(0.000, 0.000, -0.882);
static const float3 P1 = float3(0.833, 0.000, -0.176);
static const float3 P2 = float3(0.595, 0.000, 0.647);
static const float3 P3 = float3(0.000, 0.000, 0.529);
