...
// font texture.
IMGUI_IMPL_API bool ImGui_ImplDX12_Init(ID3D12Device2* device, int num_frames_in_flight, DXGI_FORMAT rtv_format,
...
IMGUI_IMPL_API void ImGui_ImplDX12_RenderDrawData(ImDrawData*                draw_data,
                                                  ID3D12GraphicsCommandList6* graphics_command_list);
